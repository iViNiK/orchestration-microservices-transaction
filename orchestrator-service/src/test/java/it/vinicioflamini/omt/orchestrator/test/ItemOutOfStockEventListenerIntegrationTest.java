...
import it.vinicioflamini.omt.orchestrator.listener.ItemOutOfStockEventListener;
...
public class ItemOutOfStockEventListenerIntegrationTest {
	...
	@Autowired
	private ItemOutOfStockEventListener consumer;
	...
	@Test
	public void testItemOutOfStockThenCompensateOrder() {
		OrderEvent event = new OrderEvent();
		event.setOrderId(10L);
		event.setItemId(10L);
		event.setAction(Action.ITEMOUTOFSTOCK);
		...
		assertEquals(Action.ITEMOUTOFSTOCK, consumer.getReceivedMessage().getAction());
